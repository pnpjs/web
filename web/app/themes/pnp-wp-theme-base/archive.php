                ...
                <h1 class="page-title">
                    <?php
                        ...
                        elseif ( is_author() ) :
                            ...
                            rewind_posts();
                        elseif ( is_day() ) :
                            printf( __( 'Daily Archives: %s', 'dw-minion' ), '<span>' . get_the_date() . '</span>' );
                        elseif ( is_month() ) :
                            printf( __( 'Monthly Archives: %s', 'dw-minion' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );
                        elseif ( is_year() ) :
                            printf( __( 'Yearly Archives: %s', 'dw-minion' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
